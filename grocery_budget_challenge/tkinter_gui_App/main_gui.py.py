...
ticketSearch_button = tk.Button(customer_details_frame, text='Search', font=('arial', 10, 'bold'), width=15, bd=5, relief='ridge', bg='steelblue', fg='white')
...
productSelection_frame.grid(row=0, column=0, padx=6, pady=2, sticky='nw')
...
productSection1_label = tk.LabelFrame(productionSection_frame, text='Drinks', font=('times new roman', 13, 'bold'), width=15, bd=7, relief='groove')
...
productSection2_label = tk.LabelFrame(productionSection_frame, text='Fruits', font=('times new roman', 13, 'bold'), width=15, bd=7, relief='groove')
...
productSection3_label = tk.LabelFrame(productionSection_frame, text='Snacks', font=('times new roman', 13, 'bold'), width=15, bd=7, relief='groove')
...
itemsCost_Entry = tk.Entry(buttonsDescription, font=('arial', 10))
...
discount_Entry = tk.Entry(buttonsDescription, font=('arial', 10))
...
tax_Entry = tk.Entry(buttonsDescription, font=('arial', 10))
...
deliveryCost_Entry = tk.Entry(buttonsDescription, font=('arial', 10))
